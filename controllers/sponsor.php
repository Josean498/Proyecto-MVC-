<?php
    ...
    class sponsor Extends Controller {
        ...
        function render() {
            session_start();
            $sponsor = $this->model->get();
            $this->view->datos = $sponsor;
            $this->view->render('sponsor/index');
        }
        ...
        function create() {
            ...
            $this->view->render('sponsor/create/index');
        }

        function edit() {
            $this->view->render('sponsor/edit/index');
        }

        function delete() {
            $this->view->render('sponsor/delete/index');
        }
